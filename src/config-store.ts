...
export function normalizeToolDisplayConfig(raw: unknown): ToolDisplayConfig {
	...
	return {
		...
		enableToolSeparator: toBoolean(source.enableToolSeparator, DEFAULT_TOOL_DISPLAY_CONFIG.enableToolSeparator),
		toolSeparatorStyle: parseEnum(source.toolSeparatorStyle, TOOL_SEPARATOR_STYLES, DEFAULT_TOOL_DISPLAY_CONFIG.toolSeparatorStyle),
		toolSeparatorColor: parseEnum(source.toolSeparatorColor, DISPLAY_COLOR_TOKENS, DEFAULT_TOOL_DISPLAY_CONFIG.toolSeparatorColor),
		userMessageBorderColor: parseEnum(source.userMessageBorderColor, DISPLAY_COLOR_TOKENS, DEFAULT_TOOL_DISPLAY_CONFIG.userMessageBorderColor),
